export const ui = {
  ...
  markdownProse:
    'prose prose-invert max-w-none prose-p:my-0 prose-p:leading-[2] prose-p:text-[color:color-mix(in_oklab,var(--text)_94%,var(--text-soft))] prose-headings:mb-5 prose-headings:mt-10 prose-headings:font-medium prose-headings:tracking-[0.03em] prose-headings:text-[var(--text)] prose-h1:mt-0 prose-h2:text-[1.55rem] prose-h3:text-[1.22rem] prose-a:text-[var(--text)] prose-a:decoration-[color:color-mix(in_oklab,var(--accent)_78%,transparent)] prose-a:underline-offset-[0.22em] hover:prose-a:text-[color:color-mix(in_oklab,var(--text)_78%,var(--accent))] prose-strong:font-semibold prose-strong:text-[color:color-mix(in_oklab,var(--text)_88%,#fff_12%)] prose-strong:[text-shadow:0_0_0.01px_currentColor] prose-code:rounded-[2px] prose-code:bg-[color:color-mix(in_oklab,var(--bg-soft)_90%,transparent)] prose-code:px-[0.3em] prose-code:py-[0.12em] prose-code:text-[0.92em] prose-code:text-[var(--text)] prose-pre:border prose-pre:border-[color:color-mix(in_oklab,var(--line)_80%,transparent)] prose-pre:bg-[color:color-mix(in_oklab,var(--bg-soft)_92%,transparent)] prose-pre:text-[var(--text)] prose-blockquote:border-l-[var(--accent)] prose-blockquote:pl-4 prose-blockquote:text-[color:color-mix(in_oklab,var(--text-soft)_92%,var(--text))] prose-hr:border-[color:color-mix(in_oklab,var(--line)_72%,transparent)] prose-ul:my-6 prose-ol:my-6 prose-li:my-1.5 prose-li:text-[color:color-mix(in_oklab,var(--text)_92%,var(--text-soft))] prose-th:text-[var(--text)] prose-td:text-[color:color-mix(in_oklab,var(--text)_90%,var(--text-soft))] prose-table:my-8 prose-table:w-full prose-thead:border-b prose-thead:border-[color:color-mix(in_oklab,var(--line)_76%,transparent)] prose-tr:border-b prose-tr:border-[color:color-mix(in_oklab,var(--line)_58%,transparent)] prose-img:my-8 prose-img:w-full prose-img:rounded-[10px] prose-img:border prose-img:border-[color:color-mix(in_oklab,var(--line)_76%,transparent)] prose-img:bg-[color:color-mix(in_oklab,var(--bg-soft)_88%,transparent)] [&_code::before]:content-none [&_code::after]:content-none',
  buttonOutline:
