...
> 内容发布 → 免费订阅增长 → 信任沉淀 → 外部平台付费承接或站内会员预研

本版本为 MVP（最小可行版本），当前优先保证稳定输出与早期受众增长，而不是提前展开付费系统。短期内网站内部不建设收费闭环；若需要商业化验证，优先依赖外部平台承接。
...
* 在达到阶段里程碑前，不开启站内收费，不将会员系统作为当前开发主线。
* 若需要验证付费内容或服务转化，优先使用外部平台，避免在受众规模不足时建设复杂站内支付系统。
...
**状态**：长期候选，当前不作为开发主线。短期商业化优先评估外部平台承接。
...
**状态**：长期候选，当前不作为开发主线。仅当外部平台无法满足内容保护、订阅管理或用户体验需求时，再评估站内支付。
